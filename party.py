...
def is_mel(name, email):
    ...
    True
    >>> is_mel('Mel Melitplosk', 'mel@ubermelon.co')
    False
    >>> is_mel('Mel Melitpolski', 'mel@ubermelon.co')
    True
    >>> is_mel('Mel Melitpolsk', 'mel@ubermelon.com')
    True
    """
    ...
    return cleaned_name == "Mel Melitpolski" or cleaned_email == "mel@ubermelon.com"
...
def most_and_least_common_type(treats):
    ...
    >>> most_and_least_common_type([{'type':'drink'},{'type':'dessert'},{'type':'dessert'}])
    ('dessert', 'drink')
